...
window.Settings = (() => {
  ...
  function connectTwitch() {
    ...
    const url = `https://id.twitch.tv/oauth2/authorize?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=token&scope=user:read:email+user:read:broadcast+clips:edit`;
